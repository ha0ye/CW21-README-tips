...
.small[River is a PhD student in biology. River has taken the standard math curriculum for biology majors and classes in biometry. 
...
River's previous research experience is in a non-computational wet lab and their current project uses physical logbooks. River has previously struggled to use Excel for stats, and is worried about the news that Excel will alter their data or introduce errors.
]
